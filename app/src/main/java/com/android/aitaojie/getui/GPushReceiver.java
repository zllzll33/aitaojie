package com.android.aitaojie.getui;
...
//                System.out.println("第三方回执接口调用" + (result ? "成功" : "失败"));
                ...
                if (payload != null) {
                    ...
                    payloadData.append("\n");
                    if(PreferenceUtil.getBoolean("CanPush",true))
                    {
                        SysUtil.sendNotification(R.string.app_name, R.mipmap.logo,R.mipmap.logo_small,"title","content", MainActivity.class,false);
                    }
                    else
                    {
