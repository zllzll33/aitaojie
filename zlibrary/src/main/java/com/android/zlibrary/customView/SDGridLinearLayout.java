...
public class SDGridLinearLayout extends LinearLayout
{
	...
	protected void create()
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			LayoutParams params = mCreaterRowItemLayoutParams.create(itemView, i);
	...
	public View getStrokeHorColor(int color, int strokeWidth)
	{
		...
		LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, strokeWidth);
	...
	public View getStrokeVerColor(int color, int strokeWidth)
	{
		View view = new View(getContext());
		view.setBackgroundColor(color);
		LayoutParams params = new LayoutParams(strokeWidth, LayoutParams.MATCH_PARENT);
		view.setLayoutParams(params);
		return view;
	}
