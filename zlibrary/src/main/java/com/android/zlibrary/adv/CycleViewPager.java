...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
   ...
   private int normalDot=R.mipmap.adv_point_normal;
	private int selecteDot=R.mipmap.adv_point_select;
	@Override
 ...
 public CycleViewPager setNormalDot(int res)
 {
	 this.normalDot=res;
	 return this;
 }
	public CycleViewPager setSelecteDot(int res)
	{
		this.selecteDot=res;
		return this;
	}
	...
	private void setIndicator(int selectedPosition) {
		for (int i = 0; i < indicators.length; i++) {
			indicators[i]
					.setBackgroundResource(normalDot);
		}
		if (indicators.length > selectedPosition)
			indicators[selectedPosition]
					.setBackgroundResource(selecteDot);
	}
